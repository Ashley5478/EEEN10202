...
start:
  ...
  setf TRISC, a ; Set all of TRISC as inputs (although only using ((PORTC) and 0FFh), 2, a:((PORTC) and 0FFh), 5, a), last four switches
...
main:
    movf PORTC, W, a ;((PORTC) and 0FFh), 2, a - ((PORTC) and 0FFh), 5, a
