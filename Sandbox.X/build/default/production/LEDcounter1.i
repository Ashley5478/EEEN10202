...
start:
    ...
    bsf TRISJ, 5, a ; ((PORTJ) and 0FFh), 5, a
...
Protection1:
    btfss PORTB, 0, a ; Test ((PORTB) and 0FFh), 0, a, skip next line if button pressed
    goto Protection1
    bra main
...
Protection2:
    btfss PORTJ, 5, a ; Test ((PORTJ) and 0FFh), 5, a, skip next line if button pressed
    goto Protection2
    bra main
