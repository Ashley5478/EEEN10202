...
FINAL_IMAGE=${DISTDIR}/Sandbox.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=TestInput.s

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/TestInput.o
POSSIBLE_DEPFILES=${OBJECTDIR}/TestInput.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/TestInput.o

# Source Files
SOURCEFILES=TestInput.s
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/Sandbox.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=PIC18F8722
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/Sandbox.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
# Rules for buildStep: pic-as-assembler
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/TestInput.o: TestInput.s  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/TestInput.o 
	${MP_AS} -mcpu=PIC18F8722 -c \
	-o ${OBJECTDIR}/TestInput.o \
	TestInput.s \
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/Sandbox.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_LD} -mcpu=PIC18F8722 ${OBJECTFILES_QUOTED_IF_SPACED} \
	-o ${DISTDIR}/Sandbox.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
